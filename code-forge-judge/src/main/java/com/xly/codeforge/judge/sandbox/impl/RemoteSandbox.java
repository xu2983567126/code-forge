...
public class RemoteSandbox implements Sandbox {
     ...
     * 取环境变量，缺失或空白时回落默认值。
     *
     * <p>本类由 {@code SandboxFactory} 直接 {@code new} 出来、不受 Spring 管理，
    ...
    private static final org.slf4j.Logger log =
            org.slf4j.LoggerFactory.getLogger(RemoteSandbox.class);
    ...
    // TODO 未来扩展点：多个远程沙箱（不同沙箱网关/协议）共享 HMAC 签名时，
    // 将 sign() 与 4 个请求头构造抽成 SandboxAuthSigner，避免签名逻辑复制。
